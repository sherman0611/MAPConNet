...
if __name__ == '__main__':
    import pymesh
    from util import visualise_geometries

    data_dir = './amass/processed'
    train_set = AMASS_Dataset(data_dir, 'train')
    vald_set = AMASS_Dataset_Eval(data_dir)

    smpl_mesh = pymesh.load_mesh('../data/npt-data/id0_0.obj')
    smpl_points = smpl_mesh.vertices
    smpl_faces = smpl_mesh.faces

    def show(i):
        mesh1, mesh2, mesh3 = train_set[i]
        visualise_geometries([smpl_points, mesh1, mesh2, mesh3], [smpl_faces] * 4)
